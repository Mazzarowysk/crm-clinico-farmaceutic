...
<body>
  ...
  <div class="page">
    <div>
      ...
      <div class="section-card" style="border-left: 3.5px solid #0d9488;">
        ...
        <p style="font-size: 8.5px; color: #475569; margin-bottom: 2px;">
          Durante a Etapa 4, o sistema executa 4 camadas simultâneas de checagem farmacológica antes de permitir a prescrição:
        </p>
        <ul style="padding-left: 12px; font-size: 8px; color: #334155; line-height: 1.3;">
  ...
  <!-- ========================================================================= -->
  <!-- PÁGINA 4: GUIA PRÁTICO DE SIMULAÇÃO CLÍNICA REAL DE BALCÃO (COMPLETO) -->
  <!-- ========================================================================= -->
  <div class="page">
    <div>
        ...
        <div class="steps-list">
          ...
          <div class="step-item">
            ...
            <div class="step-text">
              ...
              O sistema apresenta as perguntas de segurança sanitária do CFF (febre persistente > 39°C, rigidez de nuca, dor torácica ou falta de ar). Como a paciente está estável, <strong>deixe as caixas desmarcadas</strong> (mantendo o sinal verde ativo). Clique no botão <span class="btn-pill">Avançar para Prescrição &amp; Cruzamento &rarr;</span>.
            </div>
          </div>
          ...
          <div class="step-item">
            ...
            <div class="step-text">
              ...
              &bull; Clique no botão azul <span class="btn-pill">+ Prescrever</span> ao lado de <em>Paracetamol 750mg</em> (analgésico seguro para a dor e febre).<br>
              &bull; No campo de <strong>Busca Dinâmica PLN</strong>, digite <code>soro</code> e clique em <span class="btn-pill">+ Prescrever</span> nos <em>Sais para Reidratação Oral</em> para repor eletrólitos e combater a moleza/inapetência.<br>
              ...
              &bull; O painel CDSS 4D à direita exibe: <strong style="color:#059669;">&check; Nenhuma Incompatibilidade Crítica Detectada</strong>.
            </div>
          </div>
      ...
      <div class="obs-card">
        ...
        <p><strong>&bull; Racional do Paracetamol 750mg:</strong> É o analgésico de 1ª escolha para cefaleia leve/moderada em hipertensos, sem interferência na pressão arterial nem risco de sangramento gástrico de AINEs.</p>
        <p><strong>&bull; Racional dos Sais de Reidratação Oral (Soro):</strong> Mais de 65% das queixas de fraqueza no corpo e inapetência aguda são causadas por depleção eletrolítica leve. A reidratação oral acelera a recuperação celular em até 3x.</p>
        <p><strong>&bull; Função do Semáforo Red Flags:</strong> Se houver sinal grave marcado, o sistema bloqueia os MIPs e emite Guia de Encaminhamento Médico imediata.</p>
      </div>
    </div>
    ...
    <div>
      ...
      <div class="example-box">
        ...
        <div class="steps-list">
          ...
          <div class="step-item">
            <div class="step-num">4</div>
            <div class="step-text">Clique no botão verde <span class="btn-pill-green"><i class="fa-brands fa-whatsapp"></i> Lembrar Recompra</span>. O sistema abre o WhatsApp com a mensagem avisando a cliente para garantir a continuidade do tratamento.</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div>
      ...
      <div class="section-card">
        ...
        <div class="steps-list">
          <div class="step-item">
            <div class="step-num">1</div>
            <div class="step-text"><strong>Scanner por Câmera / Webcam:</strong> Clique em <span class="btn-pill">Leitor de Código de Barras</span> e aponte para a caixa. O sistema bipa e carrega o produto.</div>
          </div>
          <div class="step-item">
            <div class="step-num">2</div>
          ...
          <div class="step-item">
            <div class="step-num">3</div>
            <div class="step-text"><strong>Importação de XML de NF-e:</strong> Clique em <span class="btn-pill">Importar NF-e (XML)</span> para lançar dezenas de itens de uma só vez com seus respectivos lotes.</div>
          </div>
        </div>
      </div>
      ...
      <div class="example-box">
        ...
        <div class="steps-list">
          <div class="step-item">
            <div class="step-num">1</div>
            <div class="step-text">Na aba <strong>Estoque</strong>, clique no botão azul <span class="btn-pill">+ Novo Produto / Medicamento</span>.</div>
          </div>
          <div class="step-item">
            <div class="step-num">2</div>
          ...
          <div class="step-item">
            <div class="step-num">5</div>
            <div class="step-text">Clique em <span class="btn-pill">Salvar Produto &amp; Movimentar Entrada</span>. O produto passa a constar no inventário e alimenta a Curva ABC.</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div>
      ...
      <div class="example-box">
        ...
        <div class="steps-list">
          <div class="step-item">
            <div class="step-num">1</div>
            <div class="step-text">Acesse a aba <strong>Financeiro</strong> e clique no botão <span class="btn-pill">+ Novo Lançamento</span>.</div>
          </div>
          <div class="step-item">
            <div class="step-num">2</div>
          ...
          <div class="step-item">
            <div class="step-num">5</div>
            <div class="step-text">Clique em <span class="btn-pill">Exportar DRE em PDF</span> para gerar o Demonstrativo de Resultados consolidado.</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="page">
    <div>
      ...
      <div class="example-box" style="border: 1.5px solid #9333ea; background: #faf5ff;">
        ...
        <div class="steps-list">
          <div class="step-item">
            ...
            <div class="step-text"><strong>Acesso Rápido:</strong> No topo da aba <em>Profissionais &amp; Equipe</em>, clique no botão roxo <span class="btn-pill-purple">✨ Simulação de Atendimento Clínico</span>.</div>
          </div>
          <div class="step-item">
      ...
      <div class="obs-card" style="background: #fdf4ff; border-color: #f0abfc; border-left-color: #c026d3; color: #701a75;">
        ...
        <p><strong>&bull; Escore MEWS &ge; 5 (Alto Risco):</strong> Exige encaminhamento médico imediato ou acionamento de SAMU/Emergência.</p>
        <p><strong>&bull; Bloqueio por Interação Medicamentosa Severa:</strong> O Farmacêutico atua como barreira final de segurança antes que o paciente administre combinações letais (ex: Nitratos + Inibidores de PDE-5).</p>
      </div>
    </div>
    ...
    <div>
      ...
      <div class="example-box">
        ...
        <div class="steps-list">
          ...
          <div class="step-item">
            <div class="step-num">2</div>
            <div class="step-text">Clique no botão vermelho <span class="btn-pill" style="background:#dc2626;">⚠️ Hard Reset Total</span>.</div>
          </div>
          <div class="step-item">
            <div class="step-num">3</div>
