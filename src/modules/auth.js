...
export const getRolePermissions = (user) => {
  ...
  if (username === 'admin' || username === 'mazzarowysk' || role === 'Master') {
    return {
      ...
      allowedTabs: ['dashboard', 'farmacia', 'pacientes', 'agenda', 'relatorios', 'configuracoes'],
  ...
  if (role === 'Farmacêutico' || role === 'Farmacêutica' || role === 'Farmacêutico Clínico') {
    return {
      ...
      allowedTabs: ['dashboard', 'farmacia', 'pacientes', 'agenda', 'relatorios'],
  ...
  if (role === 'Atendente' || role === 'Recepcionista' || role === 'Balcão') {
    return {
      ...
      allowedTabs: ['dashboard', 'farmacia', 'pacientes', 'agenda'],
      canApproveUsers: false,
      canManageUsers: false,
      canDeleteRecords: false,
      canSignPEP: false,
